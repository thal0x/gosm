...
// CometClient is an autogenerated mock type for the CometClient type
type CometClient struct {
	mock.Mock
}

// ABCIInfo provides a mock function with given fields: _a0
func (_m *CometClient) ABCIInfo(_a0 context.Context) (*coretypes.ResultABCIInfo, error) {
	ret := _m.Called(_a0)
...
func (_m *CometClient) ABCIQuery(ctx context.Context, path string, data bytes.HexBytes) (*coretypes.ResultABCIQuery, error) {
...
func (_m *CometClient) ABCIQueryWithOptions(ctx context.Context, path string, data bytes.HexBytes, opts client.ABCIQueryOptions) (*coretypes.ResultABCIQuery, error) {
...
func (_m *CometClient) Block(ctx context.Context, height *int64) (*coretypes.ResultBlock, error) {
...
func (_m *CometClient) BlockByHash(ctx context.Context, hash []byte) (*coretypes.ResultBlock, error) {
...
func (_m *CometClient) BlockResults(ctx context.Context, height *int64) (*coretypes.ResultBlockResults, error) {
	ret := _m.Called(ctx, height)
...
func (_m *CometClient) BlockSearch(ctx context.Context, query string, page *int, perPage *int, orderBy string) (*coretypes.ResultBlockSearch, error) {
...
func (_m *CometClient) BlockchainInfo(ctx context.Context, minHeight int64, maxHeight int64) (*coretypes.ResultBlockchainInfo, error) {
...
func (_m *CometClient) BroadcastEvidence(_a0 context.Context, _a1 types.Evidence) (*coretypes.ResultBroadcastEvidence, error) {
...
func (_m *CometClient) BroadcastTxAsync(_a0 context.Context, _a1 types.Tx) (*coretypes.ResultBroadcastTx, error) {
	ret := _m.Called(_a0, _a1)
...
func (_m *CometClient) BroadcastTxCommit(_a0 context.Context, _a1 types.Tx) (*coretypes.ResultBroadcastTxCommit, error) {
	ret := _m.Called(_a0, _a1)
...
func (_m *CometClient) BroadcastTxSync(_a0 context.Context, _a1 types.Tx) (*coretypes.ResultBroadcastTx, error) {
	ret := _m.Called(_a0, _a1)
...
func (_m *CometClient) CheckTx(_a0 context.Context, _a1 types.Tx) (*coretypes.ResultCheckTx, error) {
	ret := _m.Called(_a0, _a1)
...
func (_m *CometClient) Commit(ctx context.Context, height *int64) (*coretypes.ResultCommit, error) {
	ret := _m.Called(ctx, height)
...
func (_m *CometClient) ConsensusParams(ctx context.Context, height *int64) (*coretypes.ResultConsensusParams, error) {
	ret := _m.Called(ctx, height)
...
func (_m *CometClient) ConsensusState(_a0 context.Context) (*coretypes.ResultConsensusState, error) {
	ret := _m.Called(_a0)
...
func (_m *CometClient) DumpConsensusState(_a0 context.Context) (*coretypes.ResultDumpConsensusState, error) {
	ret := _m.Called(_a0)
...
func (_m *CometClient) Genesis(_a0 context.Context) (*coretypes.ResultGenesis, error) {
	ret := _m.Called(_a0)
...
func (_m *CometClient) GenesisChunked(_a0 context.Context, _a1 uint) (*coretypes.ResultGenesisChunk, error) {
	ret := _m.Called(_a0, _a1)
...
func (_m *CometClient) Header(ctx context.Context, height *int64) (*coretypes.ResultHeader, error) {
	ret := _m.Called(ctx, height)
...
func (_m *CometClient) HeaderByHash(ctx context.Context, hash bytes.HexBytes) (*coretypes.ResultHeader, error) {
	ret := _m.Called(ctx, hash)
...
func (_m *CometClient) Health(_a0 context.Context) (*coretypes.ResultHealth, error) {
	ret := _m.Called(_a0)
...
func (_m *CometClient) IsRunning() bool {
	ret := _m.Called()
...
func (_m *CometClient) NetInfo(_a0 context.Context) (*coretypes.ResultNetInfo, error) {
	ret := _m.Called(_a0)
...
func (_m *CometClient) NumUnconfirmedTxs(_a0 context.Context) (*coretypes.ResultUnconfirmedTxs, error) {
	ret := _m.Called(_a0)
...
func (_m *CometClient) OnReset() error {
	ret := _m.Called()
...
func (_m *CometClient) OnStart() error {
	ret := _m.Called()
...
func (_m *CometClient) OnStop() {
	_m.Called()
}

// Quit provides a mock function with given fields:
func (_m *CometClient) Quit() <-chan struct{} {
	ret := _m.Called()
...
func (_m *CometClient) Remote() string {
	ret := _m.Called()
...
func (_m *CometClient) Reset() error {
	ret := _m.Called()
...
func (_m *CometClient) SetLogger(_a0 log.Logger) {
	_m.Called(_a0)
}

// Start provides a mock function with given fields:
func (_m *CometClient) Start() error {
	ret := _m.Called()
...
func (_m *CometClient) Status(_a0 context.Context) (*coretypes.ResultStatus, error) {
	ret := _m.Called(_a0)
...
func (_m *CometClient) Stop() error {
	ret := _m.Called()
...
func (_m *CometClient) String() string {
	ret := _m.Called()
...
func (_m *CometClient) Subscribe(ctx context.Context, subscriber string, query string, outCapacity ...int) (<-chan coretypes.ResultEvent, error) {
...
func (_m *CometClient) Tx(ctx context.Context, hash []byte, prove bool) (*coretypes.ResultTx, error) {
...
func (_m *CometClient) TxSearch(ctx context.Context, query string, prove bool, page *int, perPage *int, orderBy string) (*coretypes.ResultTxSearch, error) {
...
func (_m *CometClient) UnconfirmedTxs(ctx context.Context, limit *int) (*coretypes.ResultUnconfirmedTxs, error) {
...
func (_m *CometClient) Unsubscribe(ctx context.Context, subscriber string, query string) error {
...
func (_m *CometClient) UnsubscribeAll(ctx context.Context, subscriber string) error {
...
func (_m *CometClient) Validators(ctx context.Context, height *int64, page *int, perPage *int) (*coretypes.ResultValidators, error) {
...
// NewCometClient creates a new instance of CometClient. It also registers a testing interface on the mock and a cleanup function to assert the mocks expectations.
// The first argument is typically a *testing.T value.
func NewCometClient(t interface {
	mock.TestingT
	Cleanup(func())
}) *CometClient {
	mock := &CometClient{}
